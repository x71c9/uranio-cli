...
declare class Spawn {
    ...
    native(command: string, action: string, prefix?: string, resolve?: Resolve, reject?: Reject, detached?: boolean): cp.ChildProcessWithoutNullStreams;
    ...
    spin_and_native(command: string, action: string, prefix?: string, resolve?: Resolve, reject?: Reject, detached?: boolean): cp.ChildProcessWithoutNullStreams;
    ...
    native_promise(command: string, action: string, prefix?: string, detached?: boolean): Promise<unknown>;
    ...
    spin_and_native_promise(command: string, action: string, prefix?: string, detached?: boolean): Promise<unknown>;
