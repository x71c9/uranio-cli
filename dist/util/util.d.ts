...
export declare function spawn_log_command(command: string, context: string, color: string, callback?: () => void): cp.ChildProcessWithoutNullStreams;
export declare function spawn_verbose_log_command(command: string, context: string, color: string, callback?: () => void): cp.ChildProcessWithoutNullStreams;
export declare function spawn_native_log_command(command: string, context: string, color: string, callback?: () => void): cp.ChildProcessWithoutNullStreams;
export {};
