...
export declare function docker_unbuild(params: Partial<Params>): Promise<void>;
export declare function docker_create(params: Partial<Params>, entrypoint?: string): Promise<void>;
export declare function docker_remove(params: Partial<Params>): Promise<void>;
export declare function docker_start(params: Partial<Params>): Promise<void>;
export declare function docker_stop(params: Partial<Params>): Promise<void>;
...
export declare function docker_db_stop(params: Partial<Params>, db: DB): Promise<void>;
export declare function docker_db_remove(params: Partial<Params>, db: DB): Promise<void>;
