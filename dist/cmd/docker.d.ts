...
export declare function container_exists(container_name: string): boolean;
export declare function image_exists(image_name: string): boolean;
export declare function network_exists(network_name: string): boolean;
