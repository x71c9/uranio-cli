...
function _copy_generated_files() {
    ...
    if ((0, types_1.valid_hooks_repos)().includes(generate_params.repo)) {
...
function _run_generate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield new Promise((resolve, reject) => {
            ...
            const generate_path_js = `${generate_params.root}/${defaults_1.defaults.folder}/generate/dist/generate.js${generate_arg1}${generate_arg4}${generate_arg5}${generate_arg6}`;
            const flags = ``;
