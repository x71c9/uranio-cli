...
async function build(params) {
    ...
    cmd += ` .`;
    await util_instance.spawn.spin_and_native_promise(cmd, 'building', defaults_1.defaults.prefix_docker);
...
async function create(params, entrypoint) {
    ...
    cmd += ` ${image_name}`;
    await util_instance.spawn.spin_and_native_promise(cmd, 'creating', defaults_1.defaults.prefix_docker);
...
async function stop(params, continue_on_fail = false) {
    ...
    await util_instance.spawn.spin_and_native_promise(cmd, 'stopping', defaults_1.defaults.prefix_docker);
...
async function unbuild(params, continue_on_fail = false) {
    ...
    await util_instance.spawn.spin_and_native_promise(cmd, `removing image ${image_name}`, defaults_1.defaults.prefix_docker);
...
async function db_create(params) {
    ...
    cmd += ` mongo:5`;
    await util_instance.spawn.spin_and_native_promise(cmd, `creating db ${docker_params.db}`, defaults_1.defaults.prefix_docker);
...
async function db_start(params) {
    ...
    await util_instance.spawn.spin_and_native_promise(cmd, `starting db ${docker_params.db}`, defaults_1.defaults.prefix_docker);
...
async function db_stop(params, continue_on_fail = false) {
    ...
    await util_instance.spawn.spin_and_native_promise(cmd, `stopping db ${docker_params.db}`, defaults_1.defaults.prefix_docker);
...
async function db_remove(params, continue_on_fail = false) {
    ...
    await util_instance.spawn.spin_and_native_promise(cmd, `removing db ${docker_params.db}`, defaults_1.defaults.prefix_docker);
...
async function tmp_remove(params, continue_on_fail = false) {
    ...
    await util_instance.spawn.spin_and_native_promise(cmd_rm, `removing tmp container tmp_${container_name}`, defaults_1.defaults.prefix_docker);
...
async function network_create(params, continue_on_fail = false) {
    ...
    await util_instance.spawn.spin_and_native_promise(cmd_rm, `creating network ${network_name}`, defaults_1.defaults.prefix_docker);
...
async function prune(params, continue_on_fail = false) {
    ...
    await util_instance.spawn.spin_and_native_promise(cmd_prune, `deleteing builder cache`, defaults_1.defaults.prefix_docker);
...
async function _copy_compiled() {
    ...
    await util_instance.spawn.spin_and_native_promise(cmd_create, `creating tmp container tmp_${container_name}`, defaults_1.defaults.prefix_docker);
    let cmd_cp_node = '';
    cmd_cp_node += `docker cp tmp_${container_name}:/app/node_modules node_modules`;
    await util_instance.spawn.spin_and_native_promise(cmd_cp_node, `copying node_modules from tmp container tmp_${container_name}`, defaults_1.defaults.prefix_docker);
    // let cmd_cp_uranio = '';
    ...
    await util_instance.spawn.spin_and_native_promise(cmd_remove, `removing tmp container tmp_${container_name}`, defaults_1.defaults.prefix_docker);
