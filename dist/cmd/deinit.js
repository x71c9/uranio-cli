...
function _remove_dockers() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // await docker_stop(deinit_params);
        yield (0, docker_1.docker_db_stop)(deinit_params, dotenv.URN_DB_TYPE);
        yield (0, docker_1.docker_db_remove)(deinit_params, dotenv.URN_DB_TYPE);
        yield (0, docker_1.docker_remove)(deinit_params);
        yield (0, docker_1.docker_unbuild)(deinit_params);
    });
}
