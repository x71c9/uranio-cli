...
function _transpose_file(file_path:string, included=false){
	...
	if(
		...
		console.log(file_path, uranio_src_path, file_path.includes(uranio_src_path));
		...
		}else if(valid_admin_repos().includes(transpose_params.repo) && file_path.includes(frontend_src_path)){
